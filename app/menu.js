...
var template_win = [{
    ...
    submenu: [{
        ...
        click: function() {
            require('electron').shell.openExternal("https://github.com/munvier/Higgins/releases/tag/" + app_version)
        }
    }, {
        ...
        label: 'View ' + app_name,
        click: function() {
            require('electron').shell.openExternal("http://munvier.github.io")
        }
    }, {
        type: 'separator'
    }, {
